...
public class UsuarioDAOImpl implements UsuarioDAO {
    ...
    public void delete(Usuario usuario) {
        ...
        em.remove(usuario);
        transaction.commit();
        System.out.println("O Usuário " + usuario.getNome() + "foi Removido com Sucesso!");
    }
    ...
    public void update(Usuario usuario) {
        ...
        em.merge(usuario);
        transaction.commit();
        System.out.println("O Usuário " + usuario.getNome() + " foi Atualizado com Sucesso!");
    }
    ...
    public void save(Usuario usuario) {
        ...
        em.persist(usuario);
        transaction.commit();
        System.out.println("O Usuário " + usuario.getNome() + " foi Salvo com Sucesso!");
    }
